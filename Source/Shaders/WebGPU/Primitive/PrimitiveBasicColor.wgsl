...
@group(1) @binding(1) var shadowDepthTex: texture_depth_2d;
@group(1) @binding(2) var shadowCompSampler: sampler_comparison;
@group(1) @binding(3) var clippingPlaneTex: texture_2d<f32>;
@group(1) @binding(4) var clippingPlaneSampler: sampler;
