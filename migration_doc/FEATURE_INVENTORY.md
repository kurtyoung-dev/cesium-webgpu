...
- UP144-VECTOR-LAYER-WGSL: upstream v1.144 clamped vector-tile polylines (VectorProvider/VectorPipeline + HAS_VECTOR_LAYER in GlobeFS) are GLSL-only; uniforms ported to GlobeSurfaceTileProviderRendering, flag bit moved to 0x400000000 (eclipse owns 0x200000000); GlobeTerrain.wgsl twin unbuilt (DEFERRED_WORK UP144-VECTOR-LAYER-WGSL)
