...
- WebGPUProceduralCloudRenderer current Campaign-13 reconciliation — `CloudUniforms` is now **168
  floats** (`CLOUD_UNIFORM_FLOATS`, add-only layout). Batch 433 establishes that a temporal
