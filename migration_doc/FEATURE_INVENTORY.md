...
- UP144-SNAP-WEBGPU: upstream v1.144 experimental Scene.snap (Snapping/SnapFramebuffer/snap derived commands) is WebGL-only; on WebGPU it is a safe structural no-op (empty snap framebuffer, resolves undefined) via the alternate-renderer early-returns (DEFERRED_WORK UP144-SNAP-WEBGPU)
