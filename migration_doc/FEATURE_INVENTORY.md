...
- WebGPUBillboardRenderer — Billboard collection on WGPU (⚠️ renderer exists + 0 device errors, but renders NO VISIBLE OUTPUT in the CesiumViewer in ALL scene modes — Batch 2 audit 2026-06-07; see DEFERRED_WORK "WEBGPU-BILLBOARD-POINT-LABEL-NO-RENDER")
- WebGPULabelRenderer — SDF text label collection (⚠️ same no-visible-output state as WebGPUBillboardRenderer — see DEFERRED_WORK WEBGPU-BILLBOARD-POINT-LABEL-NO-RENDER)
...
- WebGPUPointPrimitiveRenderer — PointPrimitive collection (⚠️ same no-visible-output state as WebGPUBillboardRenderer — see DEFERRED_WORK WEBGPU-BILLBOARD-POINT-LABEL-NO-RENDER)
