...
| spec-runner-census.mjs | other | NO @purpose HEADER | 2026-09-12 | 16 | — |
...
| verify-landing-compliance.mjs | other | ACTIVE | 2026-08-28 | 27 | After-the-fact detector that re-runs the landing rules + C16 marker gate over a landed commit range, making any --no-verify hook bypass visible. |
...
| wave-end-gate.spec.mjs | spec | NO @purpose HEADER | 2026-09-16 | 16 | — |
...
| capture-and-diff.mjs | runner | ACTIVE | 2026-09-12 | 67 | Primary VR runner: drives the split-screen page over scenes.json, captures WebGL+WebGPU canvases, evaluates 3 gates vs reviewed historical baselines. |
...
| probe-runtime-lifecycle-adoption.spec.mjs | spec | NO @purpose HEADER | 2026-09-16 | 8 | — |
...
| cloud-photometry.mjs | lib | ACTIVE | 2026-09-12 | 8 | Recover linear pre-Reinhard cloud radiance from an 8-bit capture, mask the sun disc, and refuse where the recovery is not defined. |
...
| probe-runtime.mjs | lib | ACTIVE | 2026-09-12 | 56 | Owns probe argv parsing, the single-Edge-slot lock, Edge launch per run, the served-build preflight, the Sandcastle2 origin rewrite and its refusal, renderReady gating, element-only capture, sha256, receipt assembly and the exit-code table, so a probe is a short script that declares cells. |
