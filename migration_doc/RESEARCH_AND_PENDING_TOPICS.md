...
| R-2b | Unified feature-id texture | Plan | **CORE SHIPPED (2026-07-05)** — shader-samplable via `resolveFeatureIdRecolorAsync` + `FeatureIdResolve.wgsl`; residual = per-frame-PP wiring + source-tag + imagery ID channel | probe-feature-id-texture.mjs |
