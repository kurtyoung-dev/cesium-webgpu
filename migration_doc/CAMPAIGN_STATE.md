...
- **Close-out mode (2026-08-07, Batch 899; dispatch view superseded 2026-08-11; status corrected 2026-08-17):** [CLOSEOUT_PLAN_2026-08-07.md](CLOSEOUT_PLAN_2026-08-07.md) is the historical C11/C12/C13/C15-gsplat grouping. [`CAMPAIGN_PORTFOLIO_QUEUE.md`](CAMPAIGN_PORTFOLIO_QUEUE.md) is the current feature-priority dispatch view for C11–C18 and the split C15 lanes. Both are grouping only — campaign queue docs remain the sole status authorities. Critical path: C12 completion (R1/R4). `C12-29` S4 remains COMPLETE / EDGE VERIFIED, but `C13-41` / C12-29 S3 is REOPENED under `R-2026-08-14-1`: its raw shadow-contrast and measured-refresh-cost gates must be restored and independently reviewed before fresh certification. S5 and the recorded exit tail also remain open.
...
1. **C14 remains blocked on C12 completion.** `C13-41` / C12-29 S3 was recorded
   COMPLETE / EDGE VERIFIED on 2026-08-12, but that closure was invalidated by
   `R-2026-08-14-1` and the 2026-08-17 change audit. It is REOPENED until the
   raw shadow-contrast and measured-refresh-cost gates are restored, reviewed,
   and freshly certified.
2. `C12-29` S4 remains COMPLETE / EDGE VERIFIED. S5 verification (umbra vs.
   NASA shapefiles) and the recorded exit tail remain active C12-29 critical-path
   work, not a deferral.
