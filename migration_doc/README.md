...
| [`MAINTAINER_RULINGS_2026-09-02.md`](MAINTAINER_RULINGS_2026-09-02.md) | Maintainer rulings — 2026-09-02 sitting (`R-2026-09-02-1…-25`); named in CLAUDE.md as governing the next wave (Edge hold narrowed to Q-152, Wave 1 manual-three-step close, C12-29 S3 discriminator, Rust supervisor rename to `chelate`, campaign status moving into `CAMPAIGN_STATE.md`). *(Indexed 2026-09-02, DX-23.)* |
| [`MAINTAINER_RULINGS_2026-09-07.md`](MAINTAINER_RULINGS_2026-09-07.md) | Maintainer rulings — 2026-09-07 (GodRay exact-message assertion corrections, staged dependency repair in current workspace, AEC test correction ratification, feature-branch visual progress preservation). |
| [`MAINTAINER_RULINGS_2026-09-08.md`](MAINTAINER_RULINGS_2026-09-08.md) | Maintainer rulings — 2026-09-08 (GodRay fixture-identity repair, scoped Sharp compatibility update and JSDoc 4 bridge). |
| [`RULING_REQUESTS_2026-09-08.md`](RULING_REQUESTS_2026-09-08.md) | Ruling requests — 2026-09-08 (Sharp smoke pipeline construction, documentation comparison corrections). |
| [`MAINTAINER_RULINGS_2026-09-10.md`](MAINTAINER_RULINGS_2026-09-10.md) | Maintainer rulings, 2026-09-10 sitting (`R-2026-09-10-1…-8`: universal previousViewProjection tail rule enforcement, RenderCommand adoption confirmed, Astra workspace relocation, Gemini tier-3 worker role, governance updates adopted and archive sweep held, Globe.js cloud default-on hunk held, clone closeout of 65 landed lanes, Borthand F6 SCAFFOLDED inventory rating). |
| [`MAINTAINER_RULINGS_2026-09-11.md`](MAINTAINER_RULINGS_2026-09-11.md) | Maintainer rulings, 2026-09-11 sitting (`R-2026-09-11-1`: optional adversarial verifier for important batches). |
| [`MAINTAINER_RULINGS_2026-09-12.md`](MAINTAINER_RULINGS_2026-09-12.md) | <!-- corrected 2026-09-16, R-2026-09-12-10 --> *[corrected 2026-09-16, record round 5: this row opened "**Current rulings** — Maintainer rulings, 2026-09-12 sitting"; the "Current rulings" claim is struck, because two later sittings (2026-09-13 and 2026-09-16) have since been recorded and only the newest file is current. The rulings themselves are unchanged and remain in force.]* Maintainer rulings, 2026-09-12 sitting (`R-2026-09-12-1…-12`: C13 capture spine, re-sequencing, gates rewrite, Edge-leg ordering, weather sources, ground-truth imagery, Edge slot, full WebGL parity, Globe.js default, archive-hold scope, adaptive quality controller, peer head-to-head instrument; plus defaults taken on D5, D7, D8, D11, D12, D14, D15, D19 and C13-42a seat sequencing). |
| [`MAINTAINER_RULINGS_2026-09-13.md`](MAINTAINER_RULINGS_2026-09-13.md) | Maintainer rulings, 2026-09-13 sitting (`R-2026-09-13-1…-8`: the `C13-41` / `C12-29` S3 re-decision made conditional on the discriminator re-run, `RR-2026-09-13-A…-D` ratified, `RR-2026-09-11-A` quiet-hours waiver DECLINED, the three-part P0-2 close, the solo roster reserved, Edge order amended to engine-legs-first, the `C13-N10` hands-on experiment dropped, and the solo roster RE-CUT to Astra + Gemini). *(Recorded 2026-09-16 by record round 5; rulings 1, 4 and 6 are recorded NOT EXECUTED.)* |
| [`MAINTAINER_RULINGS_2026-09-16.md`](MAINTAINER_RULINGS_2026-09-16.md) | **Current rulings** — Maintainer rulings, 2026-09-16 sitting (`R-2026-09-16-1…-12`, one per `ASTRA_WORK_AUDIT_2026-09-16.md` §7 decision D1–D12: landing direction Option A — the three frozen lanes first, Astra's cloud stack rebased onto the result; the `C13-N10` resolver band kept; uniform slot 175 kept with `interleavedRefresh` appended; the `cloudAerialMode` public default; the solo proof bar — an independent reviewer **and** one named Edge leg per landing batch; RETURN/WIP features ship default-off; the same-build repeat control for the two one-pixel gates; the C16 cleanlist fold; the six `new-cap` errors; the assigned-row packets landing; Gemini's audit doc held behind nine corrections; and `C13-N07a` returning to a BLOCKED row). |
...
| [`QUEUE_2026-07-23_CAMPAIGN13.md`](QUEUE_2026-07-23_CAMPAIGN13.md) | **Current live campaign** for planetary volumetric-cloud RTE, temporal reconstruction, weather realism, quality, and performance. Re-sequenced by `R-2026-09-12-2`; gates rewritten by `C13-N46` under `R-2026-09-12-3`. |
| [`CAMPAIGN_13_V2_CLOUD_QUALITY_2026-09-12.md`](CAMPAIGN_13_V2_CLOUD_QUALITY_2026-09-12.md) | **Current C13 plan (v2.1).** Orbital-first cloud quality, two-axis S×L tiers, and — under `R-2026-09-12-8` — **full WebGL parity** in seven waves. All twenty decisions ruled 2026-09-12 (`R-2026-09-12-1…-12` + eight defaults). **The row-level authority remains `QUEUE_2026-07-23_CAMPAIGN13.md`**; this file is the plan, the bars and the wave order. |
| [`CAMPAIGN_13_V2_DECISIONS_2026-09-12.md`](CAMPAIGN_13_V2_DECISIONS_2026-09-12.md) | **Campaign 13 v2 decisions record.** The twenty maintainer decisions put to the maintainer for the v2 plan (§7), with per-option pros, cons, and recommendations. |
| [`CAMPAIGN_13_V2_REFUTATION_LOG_2026-09-12.md`](CAMPAIGN_13_V2_REFUTATION_LOG_2026-09-12.md) | **Campaign 13 v2 refutation log.** Overturned claims, corrections applied, unverified markers, and completeness critique additions for the v2 plan. |
| [`CAMPAIGN_13_V2_SOLO_ROWS_2026-09-12.md`](CAMPAIGN_13_V2_SOLO_ROWS_2026-09-12.md) | **Campaign 13 v2 solo-worker classification (companion to the v2 plan).** Which rows a lone Astra or Gemini 3.8 lane can execute with no Opus lead: the ten-item solo-safety rubric, the two workers' measured capability profiles, twelve rows specified in full (eleven SOLO-NOW, plus `DX-84` at SOLO-AFTER-TEMPLATE with its template in hand), three SOLO-AFTER-TEMPLATE rows with the template each needs, and 110 NOT-SOLO rows each naming its failing rubric item — counts as corrected on 2026-09-13 by seat rulings R-HANDOFF-8 and R-HANDOFF-10. **Classification only** — it mints no acceptance and changes no row's disposition; the row-level authority stays [`QUEUE_2026-07-23_CAMPAIGN13.md`](QUEUE_2026-07-23_CAMPAIGN13.md), whose §1 table carries the matching `[SOLO]` tags. |
| [`SOLO_WORKER_HANDOFF_2026-09-13.md`](SOLO_WORKER_HANDOFF_2026-09-13.md) | **Solo-worker dispatch pack for Campaign 13 v2 (procedure companion to [`CAMPAIGN_13_V2_SOLO_ROWS_2026-09-12.md`](CAMPAIGN_13_V2_SOLO_ROWS_2026-09-12.md)).** Written for a worker who has never seen this repository: the stop/forbidden frame, the clone-provision-freeze dispatch procedure, the rubric S1-S10 and its twenty-three additions, the Gemini/Sonnet/Astra profiles with measured limits, the roster of twelve dispatchable rows with their ruled workers and the five demoted rows with unblock conditions, the sequencing between rows, and what the seat does at landing. Carries seat rulings R-HANDOFF-1..11 (2026-09-13). |
...
| [`ASTRA_WORK_AUDIT_2026-09-16.md`](ASTRA_WORK_AUDIT_2026-09-16.md) | **Current read-only audit of Astra's solo output** (measured `c325f858c3`, Batch 1487; twelve Opus agents plus one verifier, synthesised by Hildigrim). §1 adjudicates the seventeen assigned-row packets across the Aldarion / Anarion / Arien clones (16 LAND, 1 RETURN, plus four record-only closures); §2 is the per-unit verdict table for the 43-unit cumulative volumetric-cloud preview (2 LAND · 26 LAND-WITH-FIXES · 12 RETURN · 3 NOT-A-CANDIDATE) with thirteen ranked cross-cutting findings; §3 is the measured gate table against a pristine-HEAD baseline; §4 measures the collision with the frozen L3/L4/L5 lanes and recommends landing them first; §5 is twenty ranked low-cost improvements, each with a `file:line` and an owner; §6 adjudicates Gemini's sweep; §8 is the landing plan. **§7 carries the twelve decisions D1-D12 and §9 ("Rulings taken") reproduces the twelve rulings the maintainer took at ~11:05 EDT on 2026-09-16 verbatim** — provisional `R-2026-09-16-1..12` until record round 5 writes them into the rulings file; all twelve took the option §7 recommended, and §7 is deliberately left unedited so recommendation and ruling both stay on the record. Each agent report is banked verbatim under `cesium-webgpu-worker-archive/audit-2026-09-16/`. |
| [`DOC_FITNESS_AUDIT_2026-09-04.md`](DOC_FITNESS_AUDIT_2026-09-04.md) | **Current documentation-fitness authority** (measured `dc58236ebd`, Batch 1424): five independent lenses judge the doc set for fitness for purpose, not prose quality; §3 is the gap table (each `G-` id file:line cited, refuted findings listed separately), §4 is the 30-card documentation programme (WRITE/MERGE/ARCHIVE/GUARDS) that drove documentation wave D1, §5 the ten open maintainer decisions (D1-D10). Row added by wave D1 lane 2 (Ragnir) — this file was banked into `migration_doc/` by lane 1 (Algund); reconcile if a duplicate row lands from that packet. |
...
| [`SYNC_1145_WEBGPU_PARITY_CENSUS_2026-09-05.md`](SYNC_1145_WEBGPU_PARITY_CENSUS_2026-09-05.md) | **Current parity-census authority for the 1.145 upstream sync's renderer surface.** 11 reader groups (209 findings, refuter-adjudicated) census whether 1.145's new GLSL/JS renderer functionality reached its WebGPU twin at `main` Batch 1429 (`dcf7c9c069` pre-re-land / `556f06484e` on origin): 25 PRESENT / 35 PARTIAL / 48 ABSENT / 77 NA / 23 UNADJUDICATED, merging to 22 distinct gap subjects (§3). Four largest gaps: draped-vector polygon fills (no WGSL implementation), draping onto models/3D Tiles (`ModelVectorLookupPipelineStage`, no twin), the clipping-polygon algorithm divergence (WebGL edge-texture path vs WebGPU SDF atlas), and draped-vector picking. Drives the rewritten `UPSTREAM-SYNC-1.145-07` item list (24 items) in [`QUEUE_2026-08-29_RESEARCH_DISPATCH.md`](QUEUE_2026-08-29_RESEARCH_DISPATCH.md), two `FEATURE_INVENTORY.md` §C entries, and the `AR-028`/`AR-030` amendments in [`QUEUE_2026-09-03_ARCHITECTURE_REVIEW.md`](QUEUE_2026-09-03_ARCHITECTURE_REVIEW.md). |
