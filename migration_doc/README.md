...
| [`MAINTAINER_RULINGS_2026-09-10.md`](MAINTAINER_RULINGS_2026-09-10.md) | **Current rulings** — Maintainer rulings, 2026-09-10 sitting (`R-2026-09-10-1…-8`: universal previousViewProjection tail rule enforcement, RenderCommand adoption confirmed, Astra workspace relocation, Gemini tier-3 worker role, governance updates adopted and archive sweep held, Globe.js cloud default-on hunk held, clone closeout of 65 landed lanes, Borthand F6 SCAFFOLDED inventory rating). |
| [`MAINTAINER_RULINGS_2026-09-11.md`](MAINTAINER_RULINGS_2026-09-11.md) | **Current rulings** — Maintainer rulings, 2026-09-11 sitting (`R-2026-09-11-1`: optional adversarial verifier for important batches). |
