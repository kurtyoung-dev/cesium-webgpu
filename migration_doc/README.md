...
| [`MAINTAINER_RULINGS_2026-09-12.md`](MAINTAINER_RULINGS_2026-09-12.md) | **Current rulings** — Maintainer rulings, 2026-09-12 sitting (`R-2026-09-12-1…-12`: C13 capture spine, re-sequencing, gates rewrite, Edge-leg ordering, weather sources, ground-truth imagery, Edge slot, full WebGL parity, Globe.js default, archive-hold scope, adaptive quality controller, peer head-to-head instrument; plus defaults taken on D5, D7, D8, D11, D12, D14, D15, D19 and C13-42a seat sequencing). |
