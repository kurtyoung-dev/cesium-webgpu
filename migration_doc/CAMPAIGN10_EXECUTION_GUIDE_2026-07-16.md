...
- **If C9-09-ATTACHMENT-DEMAND-REGISTRY did NOT land in C9** (check §3.2 — it is NOT STARTED as of
  2026-07-16): C10-03 (MSAA) and any consumer-demand work must build their own demand map or absorb
  C9-09 first. The H3 guide's Step 0 has the exact decision. Do not assume C9 finished its Wave-2.
...
2. **Gate 2: the early-Z spike (days-scale, measurement-only, own queue row C10-02).** One probe
