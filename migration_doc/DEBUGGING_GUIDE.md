...
| [capture-and-diff.mjs](../Tools/visual-regression/capture-and-diff.mjs) | Multi-scene visual regression suite (`scenes.json`). Run before claiming "no regression" on a big change. See [Tools/visual-regression/README.md](../Tools/visual-regression/README.md). |
...
| `probe-dusk-terminator.mjs` | Day/night terminator rendering |
