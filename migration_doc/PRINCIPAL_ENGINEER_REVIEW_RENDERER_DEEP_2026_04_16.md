...
- **(c) Routing every feature renderer through the central cache** — **PARTIALLY DONE (Batch 56, 2026-04-25).** First-cut migration of three representative renderers landed:
