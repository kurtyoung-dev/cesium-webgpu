...
- **@takram/three-clouds** (closest peer) — **deliberately NO impostor.** Reaches orbit-viable perf purely via perspective step-growth + maxRayDistance cap + 1/16 STBN TAAU. **Refuted, on narrower ground than first claimed:** the peer has no orbital demo, its cloud stories top out at 8,444 m, and it ships no WebGPU cloud backend — it does not prove impostors are unneeded for orbit performance. This is why `C13-29` was deferred; the premise is gone and the deferral goes with it. <!-- corrected 2026-09-12, R-2026-09-12-10: this sentence originally read "Key strategic finding: the mature geospatial peer proves impostors are not required for orbit performance." Refuted on verifiable facts. -->
