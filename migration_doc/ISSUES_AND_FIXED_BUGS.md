...
- **Caveat:** `drillPick` full async (`NEW-DRILLPICK-ASYNC`) and per-`EXT_mesh_features` feature pick (`C-R9-MODEL-FEATURE-PICK`) remain narrower tracked gaps; per-cell voxel pick (`C-R9-VOXEL-CELL-PICK`) out of scope.
