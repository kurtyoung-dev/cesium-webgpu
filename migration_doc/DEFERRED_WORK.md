...
- **NEW-GLOBE-DAYTIME-OCEAN-BRIGHTNESS** (surfaced 2026-07-03 during NEW-UPSTREAM-SYNC-1143 verification; PRE-EXISTING, proven by safety-branch A/B at `pre-upstream-merge-2026-07-03`) — `probe-saved-view` caribbean-mid/orbit at DAYTIME sun positions: ~90% mismatch, WebGPU ocean uniformly darker with no broad sun-glint bloom (brightness ratio ~4x GL-brighter); night-side captures show 1.03% parity. The B506 "caribbean-mid 1.08%" off-gate record was a night-side capture and masks this. Suspect territory: ocean specular/sun-glint + atmosphere daylight brightness (adjacent to the retired B2/B5/B6 below-surface epic, which only closed underground/translucency). Repro: `Tools/visual-regression/probe-saved-view.mjs` with viewer clock pinned to `2026-07-03T14:00Z` vs `2026-07-04T04:00Z` at view `-70.1037,18.485,2000000`. Next step: A/B-toggle glint/specular/atmosphere terms at a pinned daytime clock (B2's diag pattern).
