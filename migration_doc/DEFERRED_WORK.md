...
- **Custom `varyings` (vertex→fragment user varyings).** Needs new `@location` interstage slots; documented budget blocker — TAA already uses `@location` 9–10. Blocked on the varying-budget allocation.
