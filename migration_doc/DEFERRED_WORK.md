...
**Last Updated:** 2026-05-30 (_DOC_AUDIT_PLAN.md §3.2 Batch 179–185 drift sweep at HEAD `88b111e49c` Batch 185 — NEW-GROUNDPRIM-TEXTURED-MATERIALS marked RESOLVED, NEW-GROUNDPRIM-CLASSIFIER-RECON-PRECISION added as the canonical open residual, NEW-WEBGPU-GLOBE-CLASSIFY-DEPTH-PRECISION approach-(A) downgraded to producer-shipped; prior 2026-05-02 AUDIT_2026_05_02.md cross-coupling sweep)

> **⚠️ Forward-dated entries flag (added 2026-05-30, HEAD = Batch 185):** A cluster of entries below is marked `RESOLVED` against batch numbers that are FUTURE relative to HEAD = Batch 185 (`88b111e49c`) — Batches 186–230 (188/190/192/193/197/199/204/208/209/210/211/219/220/221/224/225/228/230 + their doc-sync siblings). These were NOT auto-rewritten in this pass; they need MANUAL re-verification against code (or re-marking as open) before being trusted. Do not treat a `RESOLVED (Batch 19x/2xx)` claim here as landed until cross-checked. (AUDIT_2026_05_02.md cites Batches 209–211 for gpuCull/HiZ — cross-check that specific pair first; treat the broader 186–230 band skeptically.)
...
**Remaining scope after Batch 185:** (a) ✅ per-slice `invProj` UBO + corrected `windowToEye` (Batch 173). (b) ✅ mode-aware bounding volume → correct frustum-slice distribution (Batch 174, NEW-GROUNDPRIM-CLASSIFIER-FRUSTUM-DISTRIBUTION). (c) ✅ flat Color / Stripe / Checkerboard / Grid render (Batch 185 — `packExtents` wrapper-chain walk; the depth-precision diagnosis was a red herring for the flat-render symptom). (d) ⬜ far-corner reconstruction-precision degradation — NEW-GROUNDPRIM-CLASSIFIER-RECON-PRECISION (below), the legitimately log-depth-gated residual. (e) ⬜ Image material support (texture upload + sampler binding — separate type-4 BGL extension following the GroundPolyline pattern). (f) ⬜ 2D/CV textured variant — the Batch 170 `.zxy` swizzle already places the polygon.
