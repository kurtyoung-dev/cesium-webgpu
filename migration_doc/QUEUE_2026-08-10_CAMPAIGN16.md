...
| `C16-01` | Attribution & license batch: resolve all 20 `needs-license-review` flags (mulberry32 LICENSE entry or replacement; naga-wasm ThirdParty coverage; SSGI notice; glTF sample-viewer determination; asset provenance notices for Tycho-2/LROC/Natural Earth); add `Reference:` blocks to all 43 `needs-citation` files; LICENSE.md Third-Party section entries as required | M–L | PENDING — **schedule first after C16-00; legally load-bearing** |
