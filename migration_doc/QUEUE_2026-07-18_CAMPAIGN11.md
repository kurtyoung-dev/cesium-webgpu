...
| `C11-212` (Scene.snap WebGPU parity) | **NOT STARTED — seeded 2026-08-01 by maintainer ruling (v1.144 merge follow-up)** | §1 v1.144 parity rows / G7 | RGBA32F snap target + snap pipeline variant in the WebGPU pick-pass family; currently a safe structural no-op behind the alternate-renderer early-returns. `DEFERRED_WORK.md` `UP144-SNAP-WEBGPU`. |
