...
const files = [
  "PrimitiveMatAlphaMapLit", "PrimitiveMatAspectRampLit", "PrimitiveMatBumpMapLit",
  "PrimitiveMatCheckerLit", "PrimitiveMatColorLit", "PrimitiveMatDotLit",
  "PrimitiveMatElevBandLit", "PrimitiveMatElevContourLit", "PrimitiveMatElevRampLit",
  "PrimitiveMatEmissionMapLit", "PrimitiveMatFadeLit", "PrimitiveMatGridLit",
  "PrimitiveMatImageLit", "PrimitiveMatNormalMapLit", "PrimitiveMatRimLightingLit",
  "PrimitiveMatSlopeRampLit", "PrimitiveMatSpecularMapLit", "PrimitiveMatStripeLit",
...
for (const file of files) {
  ...
  const voMatch = src.match(/(struct VertexOutput \{[\s\S]*?@location\(\d+\) eyePosition: vec3<f32>,\n)(\})/);
  if (!voMatch) throw new Error(`VertexOutput eyePosition anchor not found in ${file}`);
  src = src.replace(voMatch[0], `${voMatch[1]}${VARYING_BLOCK.replace(/^\n/, "")}\n${voMatch[2]}`);
