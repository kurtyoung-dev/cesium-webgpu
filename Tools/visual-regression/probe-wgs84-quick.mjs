...
(async () => {
  ...
  console.log(`\nSummary:`);
  console.log(`  WebGL  nonBlack=${webgl.stats.nonBlackPct.toFixed(1)}% mean=(${webgl.stats.meanR.toFixed(0)},${webgl.stats.meanG.toFixed(0)},${webgl.stats.meanB.toFixed(0)})`);
  console.log(`  WebGPU nonBlack=${webgpu.stats.nonBlackPct.toFixed(1)}% mean=(${webgpu.stats.meanR.toFixed(0)},${webgpu.stats.meanG.toFixed(0)},${webgpu.stats.meanB.toFixed(0)})`);
})();
