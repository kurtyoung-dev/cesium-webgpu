...
const debug = await page.evaluate(() => ({
  ...
  entityCount: window.__capturedViewer
    ? window.__capturedViewer.entities.values.length
    : -1,
  trackedEntity:
    window.__capturedViewer && window.__capturedViewer.trackedEntity
      ? window.__capturedViewer.trackedEntity.name
      : null,
}));
