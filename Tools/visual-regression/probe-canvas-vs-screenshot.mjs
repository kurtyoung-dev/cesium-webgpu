...
// @purpose Instrument self-check: compares getImageData bytes vs page.screenshot of the same canvas state to detect Playwright capture transforms — EXEMPLAR: retained live as the technique reference (M5)
