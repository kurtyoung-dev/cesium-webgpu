...
// frame. Camera at ~50m above ground (Pittsburgh terrain ~240m
// elevation; truck sits on terrain at 0 ellipsoid + height-adjusted
// to terrain). Truck is ~4m long → at 50m altitude looking down it
// fills ~25-40% of viewport diameter.
const VIEW = { lon: -79.9959, lat: 40.4406, height: 290.0 };
