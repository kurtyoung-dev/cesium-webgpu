...
await page.goto(
  "http://localhost:8080/Apps/Sandcastle/gallery/glTF%20PBR%20Extensions.html?renderer=webgpu",
  { waitUntil: "networkidle", timeout: 60000 },
);
// KTX2 takes time to load — give it 30s
await page.waitForTimeout(30000);
fs.writeFileSync(
  "Tools/visual-regression/output/pbr-test-webgpu.png",
...
const errs = msgs.filter(
  (m) =>
    ...
    m.toLowerCase().includes("cubemap") ||
    m.toLowerCase().includes("cube"),
);
