...
(async () => {
  console.log(`[probe-wgs84-varyings]`);
  console.log(`  rayleighV`); await capture("rayleigh-v", "_webgpuGlobeRayleighVDebug");
  console.log(`  mieV`); await capture("mie-v", "_webgpuGlobeMieVDebug");
  console.log(`  viewDir`); await capture("view-dir", "_webgpuGlobeViewDirDebug");
})();
