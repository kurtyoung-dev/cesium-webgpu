...
function multiviewSha256(bytes) {
  const source =
...
function validWebgpuCommandReceipt(value) {
  return (
    ...
    value.uploadSha256 === multiviewSha256(Uint8Array.from(value.uploadBytes))
  );
}
...
function validWebgpuRetainedReceipt(value) {
  ...
  return (
    value.beforeUploadSha256 ===
      multiviewSha256(Uint8Array.from(value.beforeUploadBytes)) &&
    value.afterBUploadSha256 ===
      multiviewSha256(Uint8Array.from(value.afterBUploadBytes)) &&
    value.afterAReentryUploadSha256 ===
      multiviewSha256(Uint8Array.from(value.afterAReentryUploadBytes)) &&
    value.bUploadSha256 ===
      multiviewSha256(Uint8Array.from(value.bUploadBytes)) &&
...
export function exitCodeForC1229S5MultiviewStatus(status) {
  return status === "PASS"
    ? 0
    : status === "FAIL"
      ? 1
