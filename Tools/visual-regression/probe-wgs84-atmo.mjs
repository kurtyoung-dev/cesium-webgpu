...
(async () => {
  ...
  await capture("fade-amount", "_webgpuGlobeFadeAmountDebug");
  console.log(`  draped`);
  await capture("draped", "_webgpuGlobeDrapedDebug");
  console.log(`  atmoColor`);
  await capture("atmo-color", "_webgpuGlobeAtmoColorDebug");
  console.log(`  transmittance`);
  await capture("transmittance", "_webgpuGlobeTransmittanceDebug");
})();
