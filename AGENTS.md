...
**The binding order lives in one tracked place:**
[`migration_doc/EXECUTOR_LANE_CHARTER_2026-08-14.md`](migration_doc/EXECUTOR_LANE_CHARTER_2026-08-14.md)
**§0.4 [HARD]**, tie-break included. This file deliberately does not restate the
order. If two sources conflict, read §0.4; if it does not decide, stop and report
...
| Whether the campaign is paused or resumed **right now**                                                                                                                                                                   | The maintainer-rulings series (`migration_doc/MAINTAINER_RULINGS_*.md`, newest file and newest ruling win; currently [`MAINTAINER_RULINGS_2026-08-21.md`](migration_doc/MAINTAINER_RULINGS_2026-08-21.md)). [`migration_doc/CAMPAIGN_STATE.md`](migration_doc/CAMPAIGN_STATE.md) mirrors it and is **not** the source |
...
| Git identity, authentication, quiet hours                                                                                                                                                                                 | `ORCHESTRATION_HANDBOOK.md` §3 (operating detail); charter §2.6 governs identity-switching restraint                                                                                                                                                                                                                  |
