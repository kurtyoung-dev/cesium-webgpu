...
| Whether the campaign is paused or resumed **right now**                                                      | `migration_doc/MAINTAINER_RULINGS_*.md` — **newest file wins, newest ruling within it**. [`CAMPAIGN_STATE.md`](migration_doc/CAMPAIGN_STATE.md) mirrors them and is **not** the source |
