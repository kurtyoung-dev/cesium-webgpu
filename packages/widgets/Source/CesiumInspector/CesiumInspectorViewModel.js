...
class CesiumInspectorViewModel {
   ...
   * @type {Command}
   */
  get showPrimitiveBoundingSphere() {
   ...
   * @type {Command}
   */
  get showPrimitiveReferenceFrame() {
