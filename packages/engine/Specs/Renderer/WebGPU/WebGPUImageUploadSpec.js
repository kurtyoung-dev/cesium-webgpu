...
describe("Renderer/WebGPU/WebGPUImageUpload", function () {
  ...
  describe("decodeWithOrientation", function () {
    ...
    it("decodes a Blob via createImageBitmap", async function () {
      ...
      // Smallest valid PNG: 1x1 transparent. The IDAT chunk length is 0x0a
      // (10 bytes of zlib stream) — NOT 0x0d. Declaring 0x0d here over-reads
      // the chunk by 3 bytes, corrupting the CRC check and making strict
      // decoders (headless Edge) throw "InvalidStateError: The source image
      // could not be decoded." See verified CRC math in the reconcile report.
