...
// `@group(2)`; no texture group separates material from effects. Ambient and
// rim lighting stay unshadowed; only direct diffuse and specular lighting is
// modulated.
//
...
fn fragmentMain(input: VertexOutput) -> FragOutput {
    ...
    // Ambient + rim stay unshadowed (rim is a non-physical artistic effect).
