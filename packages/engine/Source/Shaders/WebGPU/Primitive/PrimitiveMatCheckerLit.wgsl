...
// `@group(2)`; no texture group separates material from effects. This mirrors
// the layout in PrimitiveMatColorLit.
//
...
// Effects bind group for shadow receiving and CSM.
...
// CSM helpers matching PrimitiveMatColorLit.
