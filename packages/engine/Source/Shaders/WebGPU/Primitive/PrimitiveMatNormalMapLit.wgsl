...
// order: channels, strength, repeat. WGSL places an f32 into the vec3
// tail automatically — `strength` lands at byte 12, `repeat` at byte 16.
...
fn fragmentMain(input: VertexOutput) -> FragOutput {
    ...
    // Store the post-TBN perturbed normal used by lighting in G-buffer slot 1.
    // This keeps SSR, contact shadows, AO, and TAA disocclusion responsive to
    // normal-map detail; a geometric vertex normal would flatten those effects.
