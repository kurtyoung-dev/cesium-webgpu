 ...
 */
class SpatialNode {
  constructor(level, x, y, z, parent, shape, voxelDimensions) {
    /**
     * @type {SpatialNode[]}
     */
   ...
   */
  computeScreenSpaceError(cameraPosition, screenSpaceErrorMultiplier) {
    const obb = this.orientedBoundingBox;
   ...
   */
  computeSurroundingRenderableKeyframeNodes(keyframeLocation) {
   ...
   */
  destroyKeyframeNode(keyframeNode, megatextures) {
   ...
   * @param {Megatexture[]} megatextures
   */
  addKeyframeNodeToMegatextures(keyframeNode, megatextures) {
    if (
