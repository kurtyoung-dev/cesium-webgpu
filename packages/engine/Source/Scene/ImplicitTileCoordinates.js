...
class ImplicitTileCoordinates {
   ...
   * @private
   */
  getDescendantCoordinates(offsetCoordinates) {
    //>>includeStart('debug', pragmas.debug);
   ...
   * @private
   */
  getAncestorCoordinates(offsetLevels) {
    //>>includeStart('debug', pragmas.debug);
   ...
   */
  getOffsetCoordinates(descendantCoordinates) {
    //>>includeStart('debug', pragmas.debug);
   ...
   * @private
   */
  getChildCoordinates(childIndex) {
    //>>includeStart('debug', pragmas.debug);
   ...
   * @private
   */
  isAncestor(descendantCoordinates) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("descendantCoordinates", descendantCoordinates);
    checkMatchingSubtreeShape(this, descendantCoordinates);
    //>>includeEnd('debug');
