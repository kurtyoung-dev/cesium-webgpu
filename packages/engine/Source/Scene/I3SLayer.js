 ...
 */
class I3SLayer {
  constructor(dataProvider, layerData, parent) {
   ...
   * @private
   */
  async load(cesium3dTilesetOptions) {
   ...
   * @private
   */
  _computeGeometryDefinitions(useCompression) {
   ...
   * @private
   */
  _findBestGeometryBuffers(definition, attributes) {
   ...
   * @private
   */
  _loadRootNode(cesium3dTilesetOptions) {
   ...
   * @private
   */
  async _create3DTileset(cesium3dTilesetOptions) {
