...
class GlobeDepth {
   ...
   * @private
   */
  update(context, passState, viewport, numSamples, hdr, clearGlobeDepth) {
   ...
   * @private
   */
  prepareColorTextures(context, blitStencil) {
   ...
   */
  executeUpdateDepth(context, passState, depthTexture) {
