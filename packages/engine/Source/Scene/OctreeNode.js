 ...
 * @private
 */
function OctreeNode(center, halfExtent, depth, maxDepth, maxCommandsPerNode) {
  /**
 ...
 * @private
 */
OctreeNode.prototype._getChildIndex = function (boundingSphere) {
 ...
 * @private
 */
OctreeNode.prototype._createChild = function (index) {
  const childHalf = this.halfExtent * 0.5;
  const cx = this.center.x;
  const cy = this.center.y;
  const cz = this.center.z;
 ...
 * @private
 */
OctreeNode.prototype._split = function () {
 ...
 */
OctreeNode.prototype.insert = function (command) {
 ...
 */
OctreeNode.prototype.clear = function () {
 ...
 */
OctreeNode.prototype.collectVisible = function (
  cullingVolume,
  occluder,
  planeMask,
  result,
 ...
 */
OctreeNode.prototype.collectSorted = function (
  cameraPosition,
  frontToBack,
  result,
) {
 ...
 */
OctreeNode.prototype.getDiagnostics = function () {
  let nodeCount = 1;
