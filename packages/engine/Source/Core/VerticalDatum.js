 ...
 * water surface.
 *
 * The ocean anchor must support ellipsoid and geoid and further vertical
 * datums, derived from the selected terrain/imagery, with a manual override.
 * This enum plus {@link VerticalDatum.fromTerrainProvider} is that
 * derivation; the offset itself is applied in
 ...
 * ±107 m. `Tools/visual-regression/probe-ocean-datum.mjs` measured Cesium
 * World Terrain's ocean lid at six open-ocean sites and classified it
 ...
 * | Cesium World Terrain (`CesiumTerrainProvider`, ion 1) | GEOID   | MEASURED — probe + EGM2008 cross-check |
 ...
 * vertical datums riding the same offset — extends this table without
...
const VerticalDatum = {
  ...
  /**
   * Pin the water surface to ellipsoidal height 0 — the FFT ocean's
   * original behaviour, and the correct choice for terrain whose heights
   * really are ellipsoidal.
   * @type {string}
   * @constant
   */
  ELLIPSOID: "ELLIPSOID",
