...
class ShaderBuilder {
   ...
   */
  addDefine(identifier, value, destination) {
   ...
   */
  addStruct(structId, structName, destination) {
    //>>includeStart('debug', pragmas.debug);
   ...
   */
  addStructField(structId, type, identifier) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.string("structId", structId);
   ...
   */
  addFunction(functionName, signature, destination) {
    //>>includeStart('debug', pragmas.debug);
   ...
   * ]);
   */
  addFunctionLines(functionName, lines) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.string("functionName", functionName);
   ...
   */
  addUniform(type, identifier, destination) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.string("type", type);
    Check.typeOf.string("identifier", identifier);
    //>>includeEnd('debug');
   ...
   */
  setPositionAttribute(type, identifier) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.string("type", type);
    Check.typeOf.string("identifier", identifier);
   ...
   * shaderBuilder.addVarying("vec3", "v_color");
   */
  addVarying(type, identifier, qualifier) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.string("type", type);
    Check.typeOf.string("identifier", identifier);
    //>>includeEnd('debug');
